              ...
              <div className="border-t pt-4 mt-4">
                ...
                <Row gutter={[16, 0]}>
                  <Col span={12}>
                    <Form.Item
                      name="gameUsername"
                      label="Tên đăng nhập game"
                      tooltip="Username hoặc email để đăng nhập vào game">
                      <Input
                        placeholder="Nhập username game..."
                        disabled={isViewMode}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item
                      name="gamePassword"
                      label="Mật khẩu game"
                      tooltip="Mật khẩu để đăng nhập vào game">
                      <Input.Password
                ...
                <Row gutter={[16, 0]}>
                  <Col span={12}>
                    <Form.Item
                      ...
                      tooltip="Cách thức đăng nhập vào tài khoản game">
                      <Select
                        placeholder="Chọn phương thức đăng nhập"
                        disabled={isViewMode}
                        options={[
                  ...
                  <Col span={12}>
                    <Form.Item
                      ...
                      tooltip="Thông tin thêm về tài khoản (2FA, email backup, v.v.)">
                      <Input
